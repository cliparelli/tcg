# TCG Project A
Project Name: Heroes - The Contest
...
## Fontes de Energia  
As Fontes de Energia são cartas básicas em todo o deck. Elas vão gerar energia para os seus personagens utilizarem suas habilidades e também para os equipamentos gerarem seus efeitos. Podem haver apenas quatro fontes de energia em jogo para cada um dos jogadores e apenas uma fonte de energia (seja básica ou avançada) pode ser colocada em jogo por turno.
...
Os textos do evento que alteram a dinâmica de jogo sempre terão um alvo - seja o jogador que o invocou, seja algum oponente, personagem, tipo de ação, etc.
